  ...
  return (
    <div className="flex flex-col lg:flex-row gap-5 items-start">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start overflow-x-auto">
          {/* Canvas */}
...
function MassPrintTab({ templateId, layout, backLayout, superintendent, signatureUrl, onPrintPastorsChange }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-5 items-start">
      ...
      <div className="w-full lg:w-96 flex-shrink-0 bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
  ...
  return (
    <RoleGuard allowed={["admin", "country_assigned"]}>
      ...
      <div className="no-print">
        ...
        {/* Tab bar */}
        <div className="flex gap-1 mb-6 bg-slate-100 p-1 rounded-xl w-full sm:w-fit overflow-x-auto">
          <button
